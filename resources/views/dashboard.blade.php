...
<style>
    ...
    /* ── GREETING ── */
    .dash-greet {
        background: linear-gradient(135deg, #adc9f8 0%, #54caed 55%, #5ca9f2 100%);
        border-radius: 20px;
        padding: 32px 36px;
    ...
    .greet-dot { width:6px; height:6px; background:#FCD34D; border-radius:50%; animation:blink 2s infinite; }
    @keyframes blink { 0%,100%{opacity:1} 50%{opacity:.35} }
    .greet-name {
        font-family:'DM Serif Display',Georgia,serif;
        font-size:28px; color:white; letter-spacing:-0.8px; line-height:1.2; margin-bottom:8px;
    }
    .greet-name em { font-style:italic; color:#FCD34D; }
    .greet-sub { font-size:13.5px; color:rgba(255,255,255,.55); max-width:380px; line-height:1.6; }

    .greet-right { position:relative; z-index:1; text-align:right; flex-shrink:0; }
    .greet-date { font-size:12px; color:rgba(255,255,255,.45); margin-bottom:4px; }
    .greet-time { font-family:'DM Serif Display',Georgia,serif; font-size:36px; color:white; letter-spacing:-1px; line-height:1; }
    ...
    .stat-card.c-sky::before    { background:#0EA5E9; }
    ...
    .stat-label { font-size:12px; font-weight:500; color:#93A3B8; margin-bottom:6px; letter-spacing:.01em; }
    .stat-value {
        font-family:'DM Serif Display',Georgia,serif;
        font-size:26px; letter-spacing:-0.8px; line-height:1; margin-bottom:8px;
    }
    .sv-blue   { color:#1D4ED8; }
    .sv-indigo { color:#4F46E5; }
    .sv-sky    { color:#0284C7; }
    .sv-red    { color:#DC2626; }
    ...
    .badge-neu  { background:#EFF6FF; color:#3B82F6; }
    ...
    .chart-tab {
        ...
        background:transparent; color:#93A3B8;
    }
    .chart-tab.active { background:#EFF6FF; color:#1D4ED8; }
    .chart-tab:hover:not(.active) { background:#F8FAFF; color:#3B82F6; }
    ...
    .bar-outer { width:100%; display:flex; justify-content:center; align-items:flex-end; height:150px; }
    .bar-fill {
    ...
    .bar-fill.dim { background:linear-gradient(180deg,#BFDBFE,#93C5FD); }
    .bar-fill.gold { background:linear-gradient(180deg,#FCD34D,#F59E0B); }
    .bar-fill:hover { opacity:.85; }
    .bar-label { font-size:10px; font-weight:500; color:#93A3B8; }

    /* y axis labels */
    .chart-wrap { position:relative; }
    .y-labels {
        position:absolute; left:0; top:10px; bottom:24px;
        display:flex; flex-direction:column; justify-content:space-between;
        pointer-events:none;
    }
    .y-label { font-size:9px; color:#C7D2FE; font-weight:500; }
    ...
    .trx-list { display:flex; flex-direction:column; gap:10px; margin-top:16px; flex:1; }
    .trx-item {
        display:flex; align-items:center; gap:12px;
        padding:10px 12px; border-radius:10px;
        background:#F8FBFF; border:1px solid #EFF6FF;
        transition:background .15s;
    }
    .trx-item:hover { background:#EFF6FF; }
    .trx-ic { width:34px; height:34px; border-radius:9px; display:flex; align-items:center; justify-content:center; font-size:15px; flex-shrink:0; }
    .trx-info { flex:1; min-width:0; }
    .trx-name { font-size:12.5px; font-weight:600; color:#1E3A8A; white-space:nowrap; overflow:hidden; text-overflow:ellipsis; }
    .trx-time { font-size:10.5px; color:#93A3B8; }
    .trx-amt  { font-family:'DM Serif Display',Georgia,serif; font-size:13px; color:#1D4ED8; letter-spacing:-0.3px; white-space:nowrap; }

    .view-all {
        display:block; text-align:center; margin-top:14px;
        font-size:12px; font-weight:600; color:#3B82F6;
        text-decoration:none; padding:8px; border-radius:8px;
        background:#F0F7FF; border:1px solid #DBEAFE; transition:all .15s;
    }
    .view-all:hover { background:#DBEAFE; color:#1D4ED8; }
    ...
    @media (max-width:600px)  {
        ...
        .greet-right { display:none; }
        .dash-greet  { padding:24px 22px; }
    }
</style>
...
<div class="dash">
    ...
    <div class="dash-bottom">
        ...
        <div class="chart-card">
            ...
            <div class="bar-chart">
                <div class="bar-group"><div class="bar-outer"><div class="bar-fill dim" style="height:55%;"></div></div><div class="bar-label">Sen</div></div>
                <div class="bar-group"><div class="bar-outer"><div class="bar-fill dim" style="height:70%;"></div></div><div class="bar-label">Sel</div></div>
                <div class="bar-group"><div class="bar-outer"><div class="bar-fill"     style="height:85%;"></div></div><div class="bar-label">Rab</div></div>
                <div class="bar-group"><div class="bar-outer"><div class="bar-fill dim" style="height:60%;"></div></div><div class="bar-label">Kam</div></div>
                <div class="bar-group"><div class="bar-outer"><div class="bar-fill gold" style="height:100%;"></div></div><div class="bar-label">Jum</div></div>
                <div class="bar-group"><div class="bar-outer"><div class="bar-fill dim" style="height:75%;"></div></div><div class="bar-label">Sab</div></div>
                <div class="bar-group"><div class="bar-outer"><div class="bar-fill dim" style="height:40%;"></div></div><div class="bar-label">Min</div></div>
            </div>
