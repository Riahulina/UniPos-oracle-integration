    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .field label {
            ...
            color: var(--navy); margin-bottom: 5px; letter-spacing: .1px;
        }
        ...
        .field textarea::placeholder { color: #b8c8e0; }
        ...
        .pw-btn {
            ...
            color: #b8c8e0; transition: color .15s;
        ...
        .file-wrap:hover { border-color: var(--primary); background: var(--white); }
        .file-wrap input { display: none; }
        .file-wrap span  { font-size: 12px; color: var(--muted); }
        .file-wrap strong { color: var(--primary); }
        ...
        #previewImg { width: 26px; height: 26px; border-radius: 6px; object-fit: cover; }
        #fileName   {
        ...
        .feat-check svg { width: 10px; height: 10px; stroke: var(--sky); }
        ...
        .info-login a:hover { color: white; border-color: rgba(255,255,255,.5); }

        /* ── RESPONSIVE ───────────────────────────── */
        @media (max-width: 700px) {
            .card { grid-template-columns: 1fr; max-width: 440px; }
            .info-side { border-radius: 0; padding: 36px 28px; }
