    ...
    <div class="hero-inner">
        ...
        <div class="hero-copy">
            ...
            <div class="hero-cta">
                ...
                <a href="/login" class="btn-outline">Masuk Akun →</a>
            </div>
            ...
            <div class="dash-card">
                ...
                <div class="dash-body">
                    ...
                    <div class="chart-area">
                        ...
                        <div class="bar-row">
                            <div class="bar-col"><div class="bar-body" style="height:38px"></div><div class="bar-day">Sen</div></div>
                            <div class="bar-col"><div class="bar-body" style="height:50px"></div><div class="bar-day">Sel</div></div>
                            <div class="bar-col"><div class="bar-body bar-hi" style="height:64px"></div><div class="bar-day">Rab</div></div>
                            <div class="bar-col"><div class="bar-body" style="height:42px"></div><div class="bar-day">Kam</div></div>
                            <div class="bar-col"><div class="bar-body bar-gld" style="height:56px"></div><div class="bar-day">Jum</div></div>
                            <div class="bar-col"><div class="bar-body" style="height:34px"></div><div class="bar-day">Sab</div></div>
                            <div class="bar-col"><div class="bar-body" style="height:26px"></div><div class="bar-day">Min</div></div>
                        </div>
                    </div>
...
<section class="biz">
    <div class="biz-inner">
        <div class="biz-header">
            ...
            <p class="section-sub">UniPOS dirancang untuk beradaptasi dengan kebutuhan unik setiap jenis bisnis.</p>
        </div>
