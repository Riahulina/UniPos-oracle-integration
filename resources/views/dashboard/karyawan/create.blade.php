<x-guest-layout>
    ...
    <style>
        ...
        .reg-body-inner input::placeholder {
    ...
    <div class="reg-body">
        <div class="reg-card">
            ...
            <div class="reg-banner">
                ...
                <h1 class="reg-greeting">Tambah <em>Karyawan</em></h1>
                <p class="reg-banner-sub">Tambahkan akun karyawan untuk usaha Anda.</p>
            </div>
                ...
                <form method="POST" action="{{ route('karyawan.store') }}">
                    ...
                    <div class="reg-field">
                        ...
                        <x-text-input id="name" type="text" name="name" value="{{ old('name') }}" required
                            autofocus placeholder="Nama karyawan" />
                    ...
                    <div class="reg-field">
                        ...
                        <select name="role" id="role" required
                            style="width:100%;padding:9px 12px;border-radius:8px;border:1.5px solid #DBEAFE;background:#F0F7FF;">
